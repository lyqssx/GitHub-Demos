(function () {
  ...
  document.addEventListener('click',function(e){ var guide=e.target.closest&&e.target.closest('#demo [data-air2-wear-guide]'); if(!guide||window.V3ProLeakFlow) return; e.preventDefault(); e.stopImmediatePropagation(); var card=guide.closest('.air2-logged-summary'); if(card) card.classList.add('is-guide-open'); },true);
