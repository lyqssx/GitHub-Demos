...
(function () {
  ...
  window.air2PaintRun = function () {
    ...
    /* Air-leak events are reviewer-triggered; the run clock never creates one. */
  ...
  function air2ShowLeakSequence() {
    r72ClearLeakTimers();
    if (window.V3ProLeakFlow) return window.V3ProLeakFlow.trigger('pumping-severe');
    return false;
  }
...
(function () {
  ...
  script.src = './fit-dock-r50.js?v=fit-dock-r52';
