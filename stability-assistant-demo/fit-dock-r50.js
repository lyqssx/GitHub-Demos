...
window.v4RunFit=function(){clear();if(window.V3ProLeakFlow&&typeof window.V3ProLeakFlow.resetSession==='function')window.V3ProLeakFlow.resetSession();state.modal='fit';state.fitAdjust=true;state.fitStage=0;v4View();};
