...
function v4Log(){const l=state.milkL||7.1,r=state.milkR||7.1;return `<div class="v4-overlay"><section class="v4-log"><button class="v4-circle close" data-v4="control"><img src="./assets/stability-assistant/figma-r2/close-glyph.svg" alt="Close"></button><h1>Log Pumping Amount</h1><p class="v4-log-date">Apr 1, 9:41 AM</p><div class="v4-amounts"><div class="v4-vessel-wrap"><div class="v4-vessel"><i class="fill"></i><button data-v4="milk" data-side="l">⌃<br>⌄</button></div><p class="v4-amount-number">${l.toFixed(1)}<small>oz</small></p></div><div class="v4-measure"><b>10 oz</b>${'<i></i>'.repeat(10)}<b>0</b></div><div class="v4-vessel-wrap"><div class="v4-vessel"><i class="fill"></i><button data-v4="milk" data-side="r">⌃<br>⌄</button></div><p class="v4-amount-number">${r.toFixed(1)}<small>oz</small></p></div></div><button class="v4-duration"><span>Duration</span><b>20 min　⌄</b></button><button class="v4-start v4-save" data-v4="save">Save</button></section></div>`;}
function v4Logged(){return `<div class="v4-overlay"><section class="v4-logged v4-logged-normal"><img class="sa-logged-bg" src="./assets/stability-assistant/figma-r4/logged-bg.svg" alt=""><div class="sa-normal-logged-main"><span class="sa-logged-ip" aria-hidden="true"><img class="sa-logged-ip-main" src="./assets/stability-assistant/figma-r4/logged-ip-main.png" alt=""><img class="sa-logged-ip-overlay-a" src="./assets/stability-assistant/figma-r4/logged-ip-overlay-a.png" alt=""><img class="sa-logged-ip-overlay-b" src="./assets/stability-assistant/figma-r4/logged-ip-overlay-b.png" alt=""><img class="sa-logged-ip-highlight sa-logged-ip-highlight-left" src="./assets/stability-assistant/figma-r4/logged-ip-highlight.svg" alt=""><img class="sa-logged-ip-highlight sa-logged-ip-highlight-right" src="./assets/stability-assistant/figma-r4/logged-ip-highlight.svg" alt=""></span><div class="sa-logged-logo"><h1>Logged</h1><img src="./assets/stability-assistant/figma-r4/logged-underline.svg" alt=""></div><p>Today's data has been updated.<br>Every little change means the baby is quietly growing.</p></div><i class="v4-home-indicator"></i></section></div>`;}
